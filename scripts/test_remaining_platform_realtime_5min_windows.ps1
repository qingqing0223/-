...
$policy = @{
    ...
    "toutiao" = @{ Budget = 120; Timeout = 60; CommentCap = 100 }
...
if ($Platform -eq "toutiao") {
    ...
    Set-ConfigProperty $cfg "toutiao_realtime_detail_max_items_per_cycle" 4
    Set-ConfigProperty $cfg "toutiao_realtime_detail_budget_seconds" 120
