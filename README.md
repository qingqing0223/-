...
运行时还会自动扩展简称/常见表达、常见误写、组合检索及关联词补漏。例如“民族团结宣传周”“民族团结进取宣传周”“民族团结进步 主题宣传片”“石榴花开 宣传周”等。实时轮询每轮固定保留全部 11 个核心词，只轮换一部分补漏查询，避免扩大词库后破坏实时周期；一次性历史补采使用全部扩展查询。

**搜索命中不等于正式入库。**候选内容必须由其标题、正文/描述、标签、ASR/OCR 等公开内容本身通过主题相关性判断；source_keyword 只记录检索来源，不能单独作为有效性依据。“宣传月”、明确历史年份、其他宣传周、普通民族团结宣传、无关宣传片等会被剔除。“民族团结进步促进法”“铸牢中华民族共同体意识”“石榴花开”等关联词必须同时出现宣传周、2026、主场活动或 9 月 21—27 日等事件锚点才可入库。
